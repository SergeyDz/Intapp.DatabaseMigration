...
java -jar target/Intapp.DatabaseMigration-1.0-SNAPSHOT-jar-with-dependencies.jar mssql-connection=%mssql-connection% pgsql-connection=%pgsql-connection% skip=Configs,FormAnswers,RequestDefinitions